 ...
 *
 * <p>
 * The example uses the CloudSim Plus
 * Functional DatacenterBroker that enables
 * changing the method used for that goal,
 * without requiring to create a subclass to accomplish that.
 * </p>
 *
 * <p>
 * The example uses the class {@link DatacenterBrokerBestFit} that performs
...
public class Example {
    ...
    private Example() {
        ...
        // REEMPLAZAR POR BROKER CON SIMULATED ANNEALING
        // broker0 = new DatacenterBrokerBestFit(simulation);
        broker0 = new DatacenterBrokerSimulatedAnnealing(simulation);
    ...
    private List<Cloudlet> createCloudlets() {
        ...
        for (int i = 0; i < CLOUDLETS; i++) {
            Cloudlet cloudlet = new CloudletSimple(CLOUDLET_LENGTH, i + 1)
                    .setFileSize(1024)
                    .setOutputSize(1024)
