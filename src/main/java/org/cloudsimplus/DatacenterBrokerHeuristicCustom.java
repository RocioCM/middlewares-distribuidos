 ...
 * {@link HeuristicSolution#getFitness() fitness value}.
 * </p>
 *
 * <p>
 * Different {@link CloudletToVmMappingHeuristic} implementations can be used
 * with the {@link DatacenterBrokerHeuristic} class.
 * </p>
 *
 * @author Manoel Campos da Silva Filho
 * @since CloudSim Plus 1.0
 */
public class DatacenterBrokerHeuristicCustom {
    ...
    public static void main(String[] args) {
        new DatacenterBrokerHeuristicCustom();
    }

    /**
     * Default constructor where the simulation is built.
     */
    private DatacenterBrokerHeuristicCustom() {
    ...
    private void createSimulatedAnnealingHeuristic() {
        heuristic = new SimulatedAnnealingHeuristic();
    }
